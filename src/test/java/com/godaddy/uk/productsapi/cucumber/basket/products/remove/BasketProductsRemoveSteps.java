...
public class BasketProductsRemoveSteps extends AbstractSpringBootTest {
    ...
    public void i_ask_to_remove_products_from_basket(List<Integer> productIds) {
        this.basketApiHttpClient.removeProducts(this.basketId, productIds);
    }
    ...
    @Then("The basket value should be {double} and should be empty.")
    public void the_basket_value_should_be_and_should_be_empty(double expectedBasketValue) {
        super.verifyBasketValue(this.basketApiHttpClient, this.basketId, expectedBasketValue);
